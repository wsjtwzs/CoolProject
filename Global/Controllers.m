...
+ (UIViewController *) transferViewControllerWithCarID:(NSString *)cid
{
    return [[TransferViewController alloc] initWithNibName:NSStringFromClass([TransferViewController class]) bundle:nil carId:cid];
}
...
+ (UIViewController *) ListViewControllerWithCid:(NSString *)cid
{
    return [[ListViewController alloc] initWithCarID:cid];
}
